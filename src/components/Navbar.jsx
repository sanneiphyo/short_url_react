    ...
    <div className='flex flex-col font-normal w-full h-30 mt-3'>
      ...
      <div className='flex justify-between items-center px-12 py-3'>
        ...
        <div className='gap-5 font-semibold text-gray-600 hidden sm:flex'>
          <Link to="/" className='cursor-pointer hover:text-black'>Features</Link>
          <Link to="/" className='cursor-pointer hover:text-black'>Pricing</Link>
          <Link to="/" className='cursor-pointer hover:text-black'>Resources</Link>
        </div>
      ...
      {menuItems && (
        <div className='absolute bg-[#1e1b4b] flex-end justify-center z-3 text-gray-50 sm:hidden px-12 py-3 mx-[20%] mt-[5rem] h-96 rounded-xl font-bold text-2xl w-[70%] gap-10'>
          <div>
            <Link to="/" className='cursor-pointer hover:text-black mt-[20%] mb-5 mx-[23%]'>Features</Link>
            <Link to="/" className='cursor-pointer hover:text-black mt-5 mb-5 mx-[26%]'>Pricing</Link>
            <Link to="/" className='cursor-pointer hover:text-black mt-5 mb-5 mx-[23%]'>Resources</Link>
          </div>
          <div className='flex flex-col gap-5 items-center font-semibold border-t border-gray-50'>
            <Link to="/login" className='cursor-pointer'>Login</Link>
            <Link
              to="/signup"
              className='text-white hover:text-gray-700 w-[80%] rounded-2xl px-3 py-1 cursor-pointer bg-[#5eead4]'
            >
              Sign Up
            </Link>
          </div>
